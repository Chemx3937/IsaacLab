...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Robot
    rb10_cfg = RB_CFG.replace(prim_path="/World/Origin2/Robot")
    rb10_cfg.init_state.pos = (0.0, 0.0, 1.03)
    rb10 = Articulation(cfg=rb10_cfg)

    # Origin 3 with Kinova JACO2 (7-Dof) arm -> ur10
    ...
    # -- Robot
    ur10_cfg = UR10_CFG.replace(prim_path="/World/Origin3/Robot")
    ur10_cfg.init_state.pos = (0.0, 0.0, 0.8)
